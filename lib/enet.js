...
var _gethostbyaddr; // stub for _gethostbyaddr
  ...
  var Sockets={BACKEND_WEBSOCKETS:0,BACKEND_WEBRTC:1,BUFFER_SIZE:10240,MAX_BUFFER_SIZE:10485760,backend:0,nextFd:1,fds:{},sockaddr_in_layout:{__size__:16,sin_family:0,sin_port:2,sin_addr:4,sin_zero:8},msghdr_layout:{__size__:28,msg_name:0,msg_namelen:4,msg_iov:8,msg_iovlen:12,msg_control:16,msg_controllen:20,msg_flags:24},backends:{0:{connect:function (info) {
...
function _enet_socket_accept($socket, $address) {
  ...
  HEAP16[$address + 4 >> 1] = _htons(HEAP16[$sin + 2 >> 1]);
  STACKTOP = __stackBase__;
  return $6;
}
