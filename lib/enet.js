  ...
  L1081 : do {
    if (r7 >>> 0 < r17 >>> 0) {
      ...
      while (1) {
        ...
        r12 = r15 + HEAP32[((r13 & 255) << 2) + 411016 >> 2] | 0;
        if (r12 >>> 0 > r24 >>> 0) {
          break L1081;
        }
        HEAP32[r6] = r12;
        ...
        do {
          if ((r13 | 0) == 4) {
            ...
            _enet_protocol_handle_throttle_configure(r23, r14);
            r3 = 840;
            break;
          } else if ((r13 | 0) == 12) {
            ...
            r12 = _enet_protocol_handle_connect(r1, r14);
            if ((r12 | 0) == 0) {
              break L1081;
            } else {
              r26 = r12;
            ...
            _enet_protocol_handle_bandwidth_limit(r1, r23, r14);
            r3 = 840;
            break;
          } else if ((r13 | 0) == 9) {
        ...
        do {
          if (r3 == 841) {
            ...
            r12 = _htons((tempInt = HEAPU8[r25] | HEAPU8[r25 + 1 | 0] << 8, tempInt << 16 >> 16));
            r22 = HEAP32[r26 + 36 >> 2];
            if ((r22 | 0) == 7 | (r22 | 0) == 2) {
              r27 = r26;
              break;
            } else if ((r22 | 0) != 8) {
              _enet_peer_queue_acknowledgement(r26, r14, r12);
              r27 = r26;
              break;
            }
            if ((r13 & 15) << 24 >> 24 != 4) {
